<template>
  <div class="bg-white p-8 rounded-lg shadow-lg max-w-2xl mx-auto">
    <div class="text-center mb-8">
      ...
      <p class="text-gray-600 mt-2">请填写您的基本信息，让我们为您提供个性化的健康建议</p>
    </div>
    ...
    <form @submit.prevent="generatePlan" class="space-y-6">
      <div class="grid md:grid-cols-2 gap-6">
        ...
        <div class="space-y-2">
          <label class="block text-sm font-semibold text-gray-700">健康目标</label>
          <select 
        ...
        <div class="space-y-2">
          <label class="block text-sm font-semibold text-gray-700">活动水平</label>
          <select 
