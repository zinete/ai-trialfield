ALTER TABLE `todos` RENAME TO `note`;--> statement-breakpoint
...
CREATE TABLE `__new_note` (
	...
	`deadline` integer,
	`created_at` integer DEFAULT '"2025-10-16T08:01:35.542Z"' NOT NULL,
	`updated_at` integer DEFAULT '"2025-10-16T08:01:35.542Z"' NOT NULL
);
...
CREATE TABLE `__new_sites` (
	...
	`desc` text,
	`sort` integer,
	`created_at` integer DEFAULT '"2025-10-16T08:01:35.543Z"' NOT NULL,
	`updated_at` integer DEFAULT '"2025-10-16T08:01:35.543Z"' NOT NULL
);
--> statement-breakpoint
...
CREATE TABLE `__new_users` (
	...
	`created_at` integer DEFAULT '"2025-10-16T08:01:35.544Z"' NOT NULL
);
--> statement-breakpoint
